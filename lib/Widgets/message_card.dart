...
class _MessageCardState extends State<MessageCard> {
  ...
  void _showButtonSheet(bool isMe) {
          ...
          return ListView(
            ...
            children: [
              ...
              _OptionItem(
                  ...
                  name:
                      "Sent At : ${My_Date.getMessageTime(context: context, time: widget.message.sent)}",
                  onTap: () {}),
              _OptionItem(
                  icon:
                  ...
                  name: widget.message.read.isEmpty
                      ...
                      : "Read At : ${My_Date.getMessageTime(context: context, time: widget.message.read)}",
                  onTap: () {}),
            ],
          );
        });
